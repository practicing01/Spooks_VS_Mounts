...
for (%x=0;%x<Scene_Spooks_VS_Mounts.getCount();%x++)
{

%Object=Scene_Spooks_VS_Mounts.getObject(%x);
...
Scene_Spooks_VS_Mounts.createDistanceJoint(%Dove_Head,%Dove_Body,
%Dove_Head.getLocalPoint(%Dove_Body.Position),"0 0",0.1,3,0.0,true);

Scene_Spooks_VS_Mounts.createDistanceJoint(%Dove_Leftwing,%Dove_Body,
%Dove_Leftwing.getLocalPoint(%Dove_Body.Position),"0 0",0.1,3,0.0,true);

Scene_Spooks_VS_Mounts.createDistanceJoint(%Dove_Leftleg,%Dove_Body,
%Dove_Leftleg.getLocalPoint(%Dove_Body.Position),"0 0",0.1,3,0.0,true);

Scene_Spooks_VS_Mounts.createDistanceJoint(%Dove_Rightwing,%Dove_Body,
%Dove_Rightwing.getLocalPoint(%Dove_Body.Position),"0 0",0.1,3,0.0,true);

Scene_Spooks_VS_Mounts.createDistanceJoint(%Dove_Rightleg,%Dove_Body,
