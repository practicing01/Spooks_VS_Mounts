...
%Size.X=(%Size.X*Spooks_VS_Mounts.Resolution.X)/%Ass.Optimal_Resolution.X;

%Size.Y=(%Size.Y*Spooks_VS_Mounts.Resolution.Y)/%Ass.Optimal_Resolution.Y;
...
%Size.X=(%Size.X*Spooks_VS_Mounts.Camera_Size.X)/Spooks_VS_Mounts.Resolution.X;

%Size.Y=(%Size.Y*Spooks_VS_Mounts.Camera_Size.Y)/Spooks_VS_Mounts.Resolution.Y;
...
%Vector_2D_Scaled.X-=Spooks_VS_Mounts.Resolution.X/2;//offset cus cam is from -50 to 50

%Vector_2D_Scaled.Y-=Spooks_VS_Mounts.Resolution.Y/2;//offset cus cam is from -30 to 30

%Vector_2D_Scaled.Y=-%Vector_2D_Scaled.Y;//flip cus -y is down and +y is up

%Vector_2D_Scaled.X=(%Vector_2D_Scaled.X*Spooks_VS_Mounts.Camera_Size.X)/Spooks_VS_Mounts.Resolution.X;

%Vector_2D_Scaled.Y=(%Vector_2D_Scaled.Y*Spooks_VS_Mounts.Camera_Size.Y)/Spooks_VS_Mounts.Resolution.Y;
...
%Vector_2D_Scaled.X=(%Vector_2D_Scaled.X*Spooks_VS_Mounts.Resolution.X)/%Vector_2D_Resolution.X;

%Vector_2D_Scaled.Y=(%Vector_2D_Scaled.Y*Spooks_VS_Mounts.Resolution.Y)/%Vector_2D_Resolution.Y;
...
%Vector_2D.X=(%Vector_2D.X*Spooks_VS_Mounts.Camera_Size.X)/Spooks_VS_Mounts.Resolution.X;

%Vector_2D.Y=(%Vector_2D.Y*Spooks_VS_Mounts.Camera_Size.Y)/Spooks_VS_Mounts.Resolution.Y;
...
%Vector_2D.X=(%Vector_2D.X*Spooks_VS_Mounts.Resolution.X)/%Vector_2D_Resolution.X;

%Vector_2D.Y=(%Vector_2D.Y*Spooks_VS_Mounts.Resolution.Y)/%Vector_2D_Resolution.Y;
...
%Vector_2D.X=(%Vector_2D.X*Spooks_VS_Mounts.Resolution.X)/Spooks_VS_Mounts.Camera_Size.X;

%Vector_2D.Y=(%Vector_2D.Y*Spooks_VS_Mounts.Resolution.Y)/Spooks_VS_Mounts.Camera_Size.Y;
